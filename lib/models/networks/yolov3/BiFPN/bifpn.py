...
class BIFPN(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(self.start_level, self.backbone_end_level):#backbone_end_level = len(in_channels)#5
            l_conv = ConvModule(
                in_channels[i],
                out_channels,
                1,
        ...
        extra_levels = num_outs - self.backbone_end_level + self.start_level #num_outs = 5
