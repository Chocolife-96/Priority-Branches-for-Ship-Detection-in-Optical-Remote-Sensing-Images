...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('task', default='ctdet',
                             help='ctdet')
    self.parser.add_argument('--dataset', default='shipcoco',
                             help='coco | kitti | coco_hp | pascal | shipcoco')
    ...
    self.parser.add_argument("--model_def", type=str, default="yolov3/yolov3.cfg", 
                            help="path to model definition file")
    self.parser.add_argument("--conf_thres", type=float, default=0.98, 
                            help="object confidence threshold")
    self.parser.add_argument("--nms_thres", type=float, default=0.3, 
                            help="iou thresshold for non-maximum suppression")
    self.parser.add_argument("--results_to_save", default='yolo', 
                            help='yolo | center | both')
    self.parser.add_argument("--train_branch", default='center', 
                            help='center | bifpn | mix')
    ...
    self.parser.add_argument('--metric', default='total_loss', 
    ...
    self.parser.add_argument('--lr_step', type=str, default='80,120',
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 2, 
                'mean': [0.314, 0.325, 0.290], 'std': [0.185, 0.194, 0.215],
